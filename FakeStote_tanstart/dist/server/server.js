...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DWEf-rq_.js");
...
const manifest = { "6826078ac2d43b349bd8c0be7048326c018698db17798e64c38dcee1197b5a5b": {
  functionName: "pay_createServerFn_handler",
  importer: () => import("./assets/index-jPY1ldVj.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-ktfnY0FX.js").then((n) => n.r);
    }
    if (startEntry === null) {
